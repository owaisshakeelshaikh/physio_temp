...
const BlogPage: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen dark:bg-darkBg">
      ...
      {/* Search Bar */}
      <section className="py-8 bg-white dark:bg-darkBg border-b dark:border-darkBorder">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border border-gray-300 dark:border-darkBorder rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent bg-white dark:bg-darkCard dark:text-white"
              />
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            {/* Categories */}
            <div className="bg-white dark:bg-darkCard rounded-xl p-6 shadow-lg mb-6 border border-transparent dark:border-darkBorder">
            ...
            <div className="bg-white dark:bg-darkCard rounded-xl p-6 shadow-lg mb-6 border border-transparent dark:border-darkBorder">
              ...
              <div className="flex flex-wrap gap-2">
                {popularTags.map(tag => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-full text-sm hover:bg-primary hover:text-white transition-colors duration-300 cursor-pointer"
                  >
                    #{tag}
                  </span>
                ))}
              ...
              <div className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {featuredPosts.map(post => (
                    <div key={post.id} className="bg-white dark:bg-darkCard rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group border border-transparent dark:border-darkBorder">
            ...
            <div>
              ...
              <div className="space-y-6">
                {filteredPosts.map(post => (
                  <article key={post.id} className="bg-white dark:bg-darkCard rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group border border-transparent dark:border-darkBorder">
