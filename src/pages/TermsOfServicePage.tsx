          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing and using Healex Physiotherapy services, you accept and agree to be bound by the terms 
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Healex Physiotherapy provides professional physiotherapy and rehabilitation services. 
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-gray-800">Cancellations</h3>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Late Arrivals</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Payment and Insurance</h2>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                Healex Physiotherapy shall not be liable for any direct, indirect, incidental, special, or consequential 
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Termination of Service</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700"><strong>Email:</strong> info@healex.com</p>
                <p className="text-gray-700"><strong>Phone:</strong> (555) 123-4567</p>
                <p className="text-gray-700"><strong>Address:</strong> 123 Health Street, Medical District, City, State 12345</p>
              </div>
            </section>
          </div>
        </div>
