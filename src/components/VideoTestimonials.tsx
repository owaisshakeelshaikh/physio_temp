...
const videoTestimonials = [
  {
    ...
    review: 'After my knee surgery, the team at RestoreFlex helped me walk again in just 8 weeks. Their dedication and expertise is truly remarkable.',
    rating: 5,
  ...
  },
  {
    ...
    review: 'As a cricket player, shoulder injuries are common. RestoreFlex not only treated my rotator cuff but also improved my overall performance.',
    rating: 5,
